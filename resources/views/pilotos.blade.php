...
@section('content')
    ...
    <section id="nosotros" class="container my-5 nosotros-section">
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-center mb-5 position-relative">
            ...
            {{-- No mostrar el buscador si estamos en una vista de "show" individual (si implementaste esa bandera en el
            futuro) --}}
                ...
                <div class="search-form-container ms-md-auto mt-3 mt-md-0">
                    <form action="{{ route('pilotos.index') }}" method="POST" class="d-flex">
                        ...
                        <input type="text" name="termino_busqueda" class="form-control form-control-sm me-2"
                            placeholder="Buscar piloto..." value="{{ $searchTerm ?? '' }}" aria-label="Buscar piloto">
                        ...
                        @if(isset($searchTerm) && $searchTerm)
                            ...
                            {{-- <a href="{{ route('pilotos.index') }}"
                                class="btn btn-sm btn-outline-limpiar-custom ms-2">Limpiar</a> --}}
                        @endif
                    </form>
                </div>
            @endif
        ...
        @forelse($pilotos as $piloto)
            ...
            <div class="team-member row align-items-center mb-5">
                ...
                <div
                    ...
                    @if ($piloto->eventos && $piloto->eventos->isNotEmpty()) {{-- Comprobar que $piloto->eventos existe y no
                        está vacío --}}
                        <ul>
